...
export const { cloudRotationLimitPolicies, cloudRotationBuckets, cloudRotationReservations } = defineCloudRotationLimitSchema({ accountId: () => cloudAccounts.id, stepId: () => rotationSteps.id });
