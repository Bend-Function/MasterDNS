...
import { rotationPolicySchema, rotationStartSchema, type RotationPolicyInput } from "./rotation.schemas.js";
...
export class RotationController {
  ...
  @Post("rotations/:id/resume") resume(@CurrentUser() actor: AuthUser, @Param("id", ParseUUIDPipe) id: string, @Headers("idempotency-key") key?: string) { return this.rotations.resume(actor, id, cloudRequestKey(key)); }
}
