...
export const demoProbeRounds: ProbeRound[] = [{ id: "round-18", sequence: 18, address: "203.0.113.18", family: "4", memberIds: demoProbes.map((probe) => probe.id), localOutcome: null, localReceivedAt: null, consensus: { mode: "majority", minimumValid: 2 }, status: "completed", consensusResult: "success", deadline: demoNow, finalizedAt: demoNow, observations: [
