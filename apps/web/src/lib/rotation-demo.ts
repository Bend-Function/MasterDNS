...
export const demoRotations: RotationIncident[] = [{ cloudTarget: { ...demoCloudTarget, slot: { ...demoCloudTarget.slot, candidateVersion: 3 }, candidateAddress: { id: "address-new", address: "203.0.113.44" } }, id: "rotation-01", ownerUserId: "user-1", slotId: "slot-v4", family: "4", sourceEventId: "health-round-17-v2", status: "active", phase: "candidate", currentSegmentId: "segment-1", currentAttemptId: "attempt-1", addressVersion: 2, nextAttemptAt: demoNow, nextRunAt: demoNow, candidateDeadline: demoNow, errorCode: null, createdAt: demoNow, updatedAt: demoNow, completedAt: null }];
