...
export function RelativeTime({ value, future = false }: { value: string | Date | null | undefined; future?: boolean }) {
  ...
  useEffect(() => {
    const update = () => setLabel(future ? formatDate(timestamp) : relativeTime(timestamp));
