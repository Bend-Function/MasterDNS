...
export default function HealthPage() {
  ...
  const displayStates = new Map(policies?.map(policy => [policy.id, healthPolicyDisplay(policy, groups.find(group => group.id === policy.groupId), now)]));
