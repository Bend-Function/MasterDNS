...
export default function RotationsPage() {
  ...
  return <ConsoleLayout><PageHeader title="IP 自动轮换" description="逐台配置故障触发、定时轮换与既有换址策略" />
